...
/** InvoiceCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class InvoiceCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit InvoiceCoinUnits(QObject *parent);
...
typedef InvoiceCoinUnits::Unit InvoiceCoinUnit;

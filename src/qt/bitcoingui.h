...
/**
  InvoiceCoin GUI main class. This class represents the main window of the InvoiceCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class InvoiceCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit InvoiceCoinGUI(QWidget *parent = 0);
    ~InvoiceCoinGUI();
...
private slots:
    ...
    */
    ...
    /** Edit the Invoice-Coin.conf file */
    void editConfig();
    void editConfigExt();

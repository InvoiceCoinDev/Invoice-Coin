...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so InvoiceCoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(InvoiceCoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(InvoiceCoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(InvoiceCoinUnits::formatWithUnit(nDisplayUnit, amount, true, InvoiceCoinUnits::separatorAlways));

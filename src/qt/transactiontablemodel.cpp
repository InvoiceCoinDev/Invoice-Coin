...
{
    columns << QString() <<  QString() << tr("Date") << tr("Type") << tr("Address") << InvoiceCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
	columns[Amount] = InvoiceCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    QString str = InvoiceCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit);
    if(showUnconfirmed)
    {

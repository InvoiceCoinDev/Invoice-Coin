...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:InvoiceCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\Invoice-Coin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\InvoiceCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\InvoiceCoin.lnk"
